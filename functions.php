...
//         wp_die(
//             '<h1>Maintenance Mode</h1><p>Our website is currently undergoing scheduled maintenance. Please check back later.</p>',
//             'Maintenance Mode',
//             array( 'response' => 503 )
//         );
//     }
...
function my_custom_post_our_services() {
	$labels = array(
...
add_action( 'init', 'my_custom_post_our_services' );
